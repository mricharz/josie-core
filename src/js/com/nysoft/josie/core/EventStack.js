		...
		if(oNamespace.className) {
	    	...
	    	while(oParent && oParent.$parent && (oParent = oParent.$parent)) {
	    		if(oParent.className) {
		    		...
		    		com.nysoft.josie.core.EventStack._triggerObjectEvent(oParentNamespace, sEventName, args);
	    		}
	    	}
			
			//trigger global class-Event
			com.nysoft.josie.core.EventStack._triggerObjectEvent(oGlobalNamespace, sEventName, args);
		}

		//trigger object-event
		var oObjectNamespace = oNamespace;
		com.nysoft.josie.core.EventStack._triggerObjectEvent(oObjectNamespace, sEventName, args);
	}
};
